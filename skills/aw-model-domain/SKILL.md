...
matching `aw-tdd`); multi-context (`CONTEXT-MAP.md`) is deferred to a documented extension;
renamed to the `aw-<verb>-<noun>` family. The active-modeling reflexes, the glossary format,
